...
import copy
extrinsics_path = "/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/camera_intrinsics_extrinsics/extrinsics.json"
frame_number = 100
use_saved = False

cam1_path = f"/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/output0/pointclouds/frame_{frame_number:05d}_masked.ply"
cam2_path = f"/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/output1/pointclouds/frame_{frame_number:05d}_masked.ply"
...
#save T_inv to file
np.save("/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/camera_intrinsics_extrinsics/cam1_to_cam0.npy", T_inv)
...
mesh_cam0 = o3d.io.read_triangle_mesh(f"/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/output0/hands/frame_{frame_number}_hand_1.obj")
mesh_cam1 = o3d.io.read_triangle_mesh(f"/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/output1/hands/frame_{frame_number}_hand_1.obj")
...
if use_saved:
    T = np.load("/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/camera_intrinsics_extrinsics/hand_cam1_to_cam0.npy")
    mesh_cam1_transformed.transform(T)
else:
    mesh_cam1_transformed.transform(T)
    np.save("/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/camera_intrinsics_extrinsics/hand_cam1_to_cam0.npy", T)
...
np.savez(
    "/media/frida/3376a50a-001d-45d9-89a7-589977ec1b04/SoundingHand/DATA/0419_dual_cam_toy_example/camera_intrinsics_extrinsics/arap_indices.npz",
