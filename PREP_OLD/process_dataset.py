...
def visualize_hands(mesh_folder, output_video_path, object_mesh_path, aruco_data_path, wrist_aruco_data_path, fine_tune_T, hand_fine_tune_T=None, fps=20, marker_id=1, wrist_marker_id=0, pc_base_path=None):
    # Get all mesh files
...
if __name__ == "__main__":
    # Define paths
    DATA_NAME = "wrist_aruco_toy_example"
    ...
    object_mesh_path = os.path.join(BASE_DIR, "DATA", "objects", OBJECT_NAME + ".obj")
    mesh_folder = os.path.join(BASE_DIR, "DATA", DATA_NAME, "output", "hands")
    output_video_path = os.path.join(BASE_DIR, "DATA", DATA_NAME, "output", "hand_visualization.mp4")
    aruco_data_path = os.path.join(DATA_DIR, DATA_NAME + "_objet_tracking.pkl")
    wrist_aruco_data_path = os.path.join(DATA_DIR, DATA_NAME + "_wrist_tracking.pkl")
    
    # Define point cloud base path
    pc_base_path = os.path.join(BASE_DIR, "DATA", DATA_NAME, "output", "pointclouds")
    ...
    #                fine_tune_T, hand_fine_tune_T, marker_id=1, wrist_marker_id=0, pc_base_path=pc_base_path)
    visualize_frame(mesh_folder, frame_number=500, 
