...
def blend_meshes(mesh_cam0, mesh_cam1, hand_pc_cam0, hand_pc_cam1, combined_hand_pc, control_indices, static_indices):
    ...
    #voxel downsample combined_hand_pc
    combined_hand_pc = combined_hand_pc.voxel_down_sample(voxel_size=0.005)
...
if __name__ == "__main__":
    ...
    hand_fine_tune_T_cam1[:3, :3] = R.from_euler('xyz', [180, 0, 180], degrees=True).as_matrix() # Rotation between frames
